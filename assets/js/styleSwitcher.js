...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-compact").attr("src",  base_url+"public/assets/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src",  base_url+"public/assets/images/logo-text-white.png");
			
			setCookie('logo_src', base_url+'public/assets/images/logo-white.png');
			setCookie('logo_src2', base_url+'public/assets/images/logo-text-white.png');
		
		}else{
			jQuery('.dz-theme-mode').removeClass('active');
			
			jQuery(".nav-header .logo-abbr").attr("src", base_url+"public/assets/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", base_url+"public/assets/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src",  base_url+"public/assets/images/logo-text.png");
			
			setCookie('logo_src', base_url+'public/assets/images/logo.png');
			setCookie('logo_src2', base_url+'public/assets/images/logo-text.png');
		}
	...
	jQuery('#theme_direction').on('change',function(){
		if(html.attr('dir') === "rtl"){
			jQuery('.main-css').attr('href', base_url+'public/assets/css/style-rtl.css');
		}else{
			jQuery('.main-css').attr('href', base_url+'public/assetscss/style.css')
		}
	});
    ...
    jQuery('#theme_direction').on('change',function(){
        ...
        if(html.attr('dir') === "rtl"){
            ...
            jQuery('.main-css').attr('href',base_url+'public/assets/css/style.css')
        }
