...
dezSettings.prototype.manageNavigationBarImg = function() {
	...
	switch(this.navigationBarImg) {
        case "images/sidebar-img/1.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/1.html");
			 break;
        case "images/sidebar-img/2.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/2.html");
            break;
		case "images/sidebar-img/3.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/3.html");
            break;
		case "images/sidebar-img/4.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/4.html");
            break;
		case "images/sidebar-img/5.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/5.html");
            break;
		case "images/sidebar-img/6.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/6.html");
            break;	
		case "images/sidebar-img/7.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/7.html");
            break;
		case "images/sidebar-img/8.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/8.html");
            break;
		case "images/sidebar-img/9.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/9.html");
            break;
		case "images/sidebar-img/10.jpg": 
            body.attr("data-navigationbarimg", "images/sidebar-img/10.html");
            break;
        default:
    }
}